...
import androidx.annotation.Nullable;
    ...
    public class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static final String columnTitle = "name";  // поле колонки для заголовков записей в таблице в БД
        private static final String columnBreed = "breed";
        ...
        public void onCreate(SQLiteDatabase db) {
           ...
           /* String query = "CREATE TABLE " + tableName + " (" + columnId + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                    + columnTitle + " TEXT, " /*+ columnBreed +  " TEXT);";*/
        ...
        public void addNotes(String name, String breed, String description) {
        ...
        public void deleteAllNotes() {
            ...
            //updateNotes(columnTitle, columnDescription, columnId);
